  ...
  return (
    <form action={action} ref={formRef} className='mt-4'>
        ...
        <div className='flex flex-row gap-4'>
            <input type="text" name='title' id='title' className='border rounded-md mt-2 pl-4'/>
            <button type='submit' className='bg-black text-white px-2 py-1 rounded-md text-sm'>
                Add todo
            </button>
        </div>
    </form>
